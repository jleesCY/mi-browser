...
const SwipeableHistoryRow = ({ item, onPress, onDelete, theme, accent, radius, height, margin, fontScale }: any) => {
    ...
    return (
      <Animated.View style={{ marginBottom: margin, height: itemHeight, opacity, justifyContent: 'center' }}>
        ...
        <Animated.View
          style={{ transform: [{ translateX }], backgroundColor: 'transparent', height: '100%', justifyContent:'center' }}
...
const styles = StyleSheet.create({
  historyItem: { flexDirection: 'row', alignItems: 'center', paddingVertical: 12, paddingHorizontal: 15 },
